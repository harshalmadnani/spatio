  ...
  try {
    ...
    if (hyperdriveConfig.kind === "StETHHyperdrive") {
      ...
      if (await isV1_0_14(hyperdrive)) {
        return new ReadStEthHyperdrive_v1_0_14(options) as ReadHyperdrive;
      }
    ...
    if (hyperdriveConfig.kind === "MorphoBlueHyperdrive") {
      ...
      // <= v1.0.14
      if (await isV1_0_14(hyperdrive)) {
        return new ReadMetaMorphoHyperdrive_v1_0_14(options) as ReadHyperdrive;
      }
    ...
    // <= v1.0.14
    if (await isV1_0_14(hyperdrive)) {
      return new ReadHyperdrive_v1_0_14(options) as ReadHyperdrive;
    }
